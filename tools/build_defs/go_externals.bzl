...
def go_externals():
    ...
    go_repository(
        ...
        sum = "h1:X5YRFJiteUM3rajABEYJSzw1KWgmp1ulPFKxpfLm0M4=",
        version = "v0.0.0-20160217103242-c068ca2f0aac",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:hosh+PHX01NJfxAVQqedA4UHi/zo8VGmAB0Pz0YK0yw=",
        version = "v1.3.2",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_nelhage_go_cli",
        importpath = "github.com/nelhage/go.cli",
        sum = "h1:RPjitJVxtv+vBCezBG5cYcmycshpR1BjKKUX7CXSFgI=",
        version = "v0.0.0-20140717043504-2aeb96ef8025",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:/5j+ftuIYINCYnGLlC8TKk/EYNaijSPow5UVrA4AvpM=",
        version = "v0.0.0-20230112115613-e0cf62d238b9",
    )
    ...
    go_repository(
        ...
        sum = "h1:/ZBsgjXWUpiZ5M9zm+Ft3kuDUGErIGcEJbKRIsFN6jA=",
        version = "v1.11.1",
    )
    go_repository(
